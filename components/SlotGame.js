...
const SYM_H = 88, STRIP = 32; // must match --reel-h in globals.css
            ...
            <div className="form-state" id="form-state">
              ...
              <div className="consent-row">
                ...
                <label htmlFor="f-consent">
                  I agree to be contacted about my submission as described in our <Link href="/privacy">Privacy Policy</Link>.
                </label>
              </div>

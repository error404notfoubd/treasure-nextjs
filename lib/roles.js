...
/**
 * Whether the actor may toggle `profiles.receive_verified_lead_notifications` for the target.
 * Owners: any role. Admins: editors and viewers only (not other admins or owners).
 */
export function canToggleVerifiedLeadNotifications(actorRole, targetRole) {
  if (actorRole === "owner") return true;
  if (actorRole === "admin" && (targetRole === "editor" || targetRole === "viewer")) return true;
  return false;
}
